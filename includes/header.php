...
<body>
    ...
    <div class="max-w-6xl mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <a href="<?php echo BASE_URL;?>pages/index.php"class="text-xl font-bold">Tienda</a>

                <div class="hidden md:flex space-x-6 ">
                    <a href="<?php echo BASE_URL;?>pages/caballero.php" class="text-1xl rounded-lg p-3 font-bold relative group">
                        Caballero
                        <span class="absolute left-0 bottom-0 w-0 h-0.5 bg-stone-300 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    <a href="<?php echo BASE_URL;?>pages/dama.php" class="text-1xl rounded-lg p-3 font-bold relative group">
                        Dama
                        <span class="absolute left-0 bottom-0 w-0 h-0.5 bg-stone-300 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    <a href="<?php echo BASE_URL;?>pages/ninos.php" class="text-1xl rounded-lg p-3 font-bold relative group">
                        Niño
                        <span class="absolute left-0 bottom-0 w-0 h-0.5 bg-stone-300 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    <a href="<?php echo BASE_URL;?>pages/nosotros.php" class="text-1xl rounded-lg p-3 font-bold relative group">
                        Sobre nosotros
                        <span class="absolute left-0 bottom-0 w-0 h-0.5 bg-stone-300 group-hover:w-full transition-all duration-300"></span>
                    </a>
